        ...
        <form action="#" method="post" className="booking-container">
          <div className="booking-info">
            ...
            <div className="booking__infor">
              ...
              <div className="form-group">
                ...
                <input type="number" id="tel" placeholder="Nhap so dien thoai lien he" name="tel" required />
            ...
            <div className="booking__quantity">
              <div className="form-group quantity-selector">
                ...
                <div className="input__quanlity">
                  <button type="button" className="quantity-btn">-</button>
                  <input
                    type="number"
                    ...
                    id="numAdults"
                    name="numAdults"
                    data-price-adults={tour.priceAdult}
                    readOnly
                  />
                  <button type="button" className="quantity-btn">+</button>
                </div>
              ...
              <div className="form-group quantity-selector">
                ...
                <div className="input__quanlity">
                  ...
                  <input
                    ...
                    id="numChildren"
                    name="numChildren"
                    data-price-children={tour.priceChild}
                    readOnly
                  />
                  <button type="button" className="quantity-btn">+</button>
                </div>
          ...
          <div className="booking-summary">
            <div className="summary-section">
              <div>
                <p>Ma tour : {tour.tourId}</p>
                <input type="hidden" name="tourId" id="tourId" value={tour.tourId} />
                <h5 className="widget-title">{tour.title}</h5>
                <p>Ngay khoi hanh : {tour.startDate}</p>
                <p>Ngay ket thuc : {tour.endDate}</p>
                <p className="quantityAvailable">So cho con nhan : {tour.quantity}</p>
              </div>
              ...
              <div className="order-summary">
                ...
                <div className="summary-item total-price">
                  <span>Tong cong:</span>
                  <span>0 VND</span>
                  <input type="hidden" className="totalPrice" name="totalPrice" value="" />
                </div>
              </div>
              <div className="order-coupon">
                <input type="text" placeholder="Ma giam gia" style={{ width: "65%" }} />
                <button style={{ width: "30%" }} className="booking-btn btn-coupon">
                  Ap dung
                </button>
              </div>
